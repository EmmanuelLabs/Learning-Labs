...
## Objective
The objective of this lab is to understand how Git handles mistakes in a repository and how developers can safely recover from them.

 The experiment demonstrates methods for:
 - undoing incorrect commits
 - restoring deleted files 
 - reversing changes 
 that have already been pushed to a remote repository.
